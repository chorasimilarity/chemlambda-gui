...
######### demos=0 makes all initial nodes to have the colour demos_col
...
# ignores the lines with less than 3 fields  (no loop element)

      if (NF == 3) { 
       node[NR]=$0;      node_type[NR]=$1;
       
       node_port_1[NR]=$2;   node_actor[NR]=$3; 
...
# node_type has as argument the node number and as value the node type.
       ...
       if ( NF == 4 ) {  node_type[NR]=$1;  node[NR]=$0;
       ...
       if (NF == 5) {  node_port_1[NR]=$2;  node[NR]=$0; node_type[NR]=$1; 
       
       node_port_2[NR]=$3; node_port_3[NR]=$4; node_actor[NR]=$5;
                           }
...
for ( i in node) {
                  ...
                  if (s == "A") {   a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "FI") {  a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "L") { a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "FO" ) {  a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if ( s == "FOE" ) {  a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "Arrow") {  a=node_port_1[i]; b=node_port_2[i]; d=node_actor[i];
...
############### Busy Beaver nodes
                    ...
                    if (s == "B0") {  a=node_port_1[i]; b=node_port_2[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "B1") {  a=node_port_1[i]; b=node_port_2[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "BA") {  a=node_port_1[i]; b=node_port_2[i];  d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "BB") {  a=node_port_1[i]; b=node_port_2[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "BC") {  a=node_port_1[i]; b=node_port_2[i];  d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "BHALT") {  a=node_port_1[i]; b=node_port_2[i];  d=node_actor[i];
...
# definition of internal edges
                     ...
                     if (s == "BM") {  a=node_port_1[i]; b=node_port_2[i];  d=node_actor[i];
...
############### end Busy Beaver nodes    
                    ...
                    if (s == "T" ) { a=node_port_1[i]; d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "FROUT" ) {  a=node_port_1[i];   d=node_actor[i];
...
# definition of internal edges
                    ...
                    if (s == "FRIN" ) { a=node_port_1[i];   d=node_actor[i];
...
# add FRIN and FROUT nodes, if they are needed, and the bond property
    ...
    if ( k==1 ) {  if (a in all_edge_source ) {  ddd=all_edge_source[a];  d=all_node_actor[ddd];
...
# definition of internal edges
      ...
      }     else { ddd=all_edge_target[a];  d=node_actor[ddd];
...
# print the first part of the html file, for the moment is called essy.txt
 ...
 if (demos=="0") {
         ...
         vuvu="graph.addNode( \"" all_node_id[r] "\", \"" all_node_atom[r] "\",  " all_node_size[r] ",  \"" demos_col "\"); \n" ; } 
  else   {  gugus=all_node_actor[r]; 
#     vuvu="graph.addNode( \"" all_node_id[r] "\", \"" all_node_atom[r] "\",  " all_node_size[r] ",  \"" all_node_colour[r] "\"); \n" ; 

 vuvu="graph.addNode( \"" all_node_id[r] "\", \"" all_node_atom[r] "\",  " all_node_size[r] ",  \"" linkcol[gugus] "\"); \n" ; }
...
# PROP
  ...
  growcont++;    
    ...
    targeac=all_node_id[targe];
    targeact=all_node_actor[targeac];
...
#definition of FOE node and edges, internal and external, in proposed_add
                                  ...
                                  proposed_all_node_actor[junu]=targeact;
                                  ...
                                  proposed_all_node_actor[j1]=targeact;
                                  ...
                                  proposed_all_node_actor[j2]=targeact;
                                  ...
                                  proposed_all_node_actor[j3]=targeact;
...
#definition of left propagated node and edges, internal and external, in proposed_add
                                  ...
                                  proposed_all_node_actor[jdoi]=targeact;
...
#definition of right propagated node and edges, internal and external, in proposed_add
                                  ...
                                  proposed_all_node_actor[jtrei]=targeact;
...
#proposed for add edges
 ...
 #definition of B0 node and edges
                                  ...
                                  proposed_all_node_id[junu]=junu;
                                  proposed_all_node_actor[junu]=zeze;
                                  ...
                                  proposed_all_node_colour[j1]=in_col;
                                  proposed_all_node_id[j1]=j1;
                                  proposed_all_node_actor[j1]=zeze;
                                  proposed_all_edge_int[j1]=je_1;
                                  proposed_all_edge_out[j1]=intera;
                                  proposed_all_edge_target[intera]=j1; 
                                  ...
                                  proposed_all_node_colour[j2]=out_col;
                                  proposed_all_node_id[j2]=j2;
                                  proposed_all_node_actor[j2]=zeze;
                                  proposed_all_edge_int[j2]=je_2;
...
# definition of internal edges
 ...
 #definition of FRIN node and edges
                                  ...
                                  proposed_all_node_id[jdoi]=jdoi;
                                  proposed_all_node_actor[jdoi]=zeze;
...
# definition of nodes: 
                                  ...
                                  proposed_all_node_id[jtrei]=jtrei;
                                  proposed_all_node_actor[jtrei]=zeze;
...
# FIFRIN
 ...
 parame=int((wei_FIFRIN*diefact * rand())+int(cocoact*rise*rand()));
...
#   parame=0;
    ...
    diecont++;
     ...
     targid=all_node_atom[targe];
     sourcid=all_node_atom[sourc];
     zeze=all_node_actor[targe];

    if (sourcid=="FRIN" && targid=="FI") {  if ( targe in node_block || sourc in node_block ) {zuzuzu=0;} else {
...
# identified nodes, with their ports, then defines the new edges, internal and external
      ...
      unuup1=all_node_id[targe] "_1";
      unuup2=all_node_id[targe] "_2";

      if (targ==unuup1) { unuu=unuup2; } else {unuu=unuup1;}

      doii=all_node_id[targe] "_3";
...
#end of random parame for FIFRIN
}    
...
#definition of FOE node and edges, internal and external, in proposed_add
                                  ...
                                  proposed_all_node_colour[junu]=in_col;
                                  proposed_all_node_id[junu]=junu;
                                  proposed_all_node_actor[junu]=zaza;
                                  ...
                                  proposed_all_node_colour[j1]=in_col;
                                  proposed_all_node_id[j1]=j1;
                                  proposed_all_node_actor[j1]=zaza;
                                  proposed_all_edge_int[j1]=je_1;
                                  proposed_all_edge_out[j1]=unu;
                                  proposed_all_edge_target[unu]=j1; 
                                  ...
                                  proposed_all_node_colour[j2]=out_col;
                                  proposed_all_node_id[j2]=j2;
                                  proposed_all_node_actor[j2]=zaza;
                                  proposed_all_edge_int[j2]=je_2;
                                  ...
                                  proposed_all_node_colour[j3]=out_col;
                                  proposed_all_node_id[j3]=j3;
                                  proposed_all_node_actor[j3]=zaza;
                                  proposed_all_edge_int[j3]=je_3;
...
#definition of FI node and edges, internal and external
                                  ...
                                  proposed_all_node_colour[jdoi]=out_col;
                                  proposed_all_node_id[jdoi]=jdoi;
                                  proposed_all_node_actor[jdoi]=zaza;
...
#definition of FO node and edges, internal and external
                                  ...
                                  proposed_all_node_id[jtrei]=jtrei;
                                  proposed_all_node_actor[jtrei]=zaz2;
                                  ...
                                  proposed_all_node_colour[j1]=in_col;
                                  proposed_all_node_id[j1]=j1;
                                  proposed_all_node_actor[j1]=zaz2;
                                  proposed_all_edge_int[j1]=je_1;
                                  ...
                                  proposed_all_node_colour[j2]=out_col;
                                  proposed_all_node_id[j2]=j2;
                                  proposed_all_node_actor[j2]=zaz2;
                                  proposed_all_edge_int[j2]=je_2;
                                  proposed_all_edge_out[j2]=intera;
                                  proposed_all_edge_source[intera]=j2; 
                                  ...
                                  proposed_all_node_colour[j3]=out_col;
                                  proposed_all_node_id[j3]=j3;
                                  proposed_all_node_actor[j3]=zaz2;
                                  proposed_all_edge_int[j3]=je_3;
...
#definition of FO node and edges, internal and external
                                  ...
                                  proposed_all_node_actor[jpatru]=zaz3;
                                  ...
                                  proposed_all_node_colour[j1]=in_col;
                                  proposed_all_node_id[j1]=j1;
                                  proposed_all_node_actor[j1]=zaz3;
                                  proposed_all_edge_int[j1]=je_1;
                                  ...
                                  proposed_all_node_colour[j2]=out_col;
                                  proposed_all_node_id[j2]=j2;
                                  proposed_all_node_actor[j2]=zaz3;
                                  proposed_all_edge_int[j2]=je_2;
                                  proposed_all_edge_out[j2]=interb;
                                  proposed_all_edge_source[interb]=j2; 
                                  ...
                                  proposed_all_node_colour[j3]=out_col;
                                  proposed_all_node_id[j3]=j3;
                                  proposed_all_node_actor[j3]=zaz3;
                                  proposed_all_edge_int[j3]=je_3;
...
#definition of FI node and edges, internal and external
                                  ...
                                  proposed_all_node_size[jtrei]=main_const;
                                  proposed_all_node_colour[jtrei]=out_col;
                                  proposed_all_node_id[jtrei]=jtrei;
                                  proposed_all_node_actor[jtrei]=zaz2;
...
#definition of FI node and edges, internal and external
                                  ...
                                  proposed_all_node_size[jpatru]=main_const;
                                  proposed_all_node_colour[jpatru]=out_col;
                                  proposed_all_node_id[jpatru]=jpatru;
                                  proposed_all_node_actor[jpatru]=zaz3;
...
##############################################################################!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                                  ...
                                  proposed_all_node_colour[junu]=arrow_col;
                                  proposed_all_node_id[junu]=junu;
                                  proposed_all_node_actor[junu]=zaz3;
...
#definition of Arrow node and edges, internal and external
                                  ...
                                  proposed_all_node_id[jdoi]=jdoi;
                                  proposed_all_node_actor[jdoi]=zaz2;
...
#end of random parame for FAN-IN
}
...
####   
  ...
  all_node_colour[nodc]=nodcol;
   ...
   all_node_actor[nodc]=proposed_all_node_actor[nodc];
   
 

 printf("setTimeout(function() \{  \n \n ") >> "essy.txt";

nodact=all_node_actor[nodc];

#   printf("graph.addNode( \"" nodid "\", \"" noda "\", \"" nodsi "\", \"" nodcol "\")\; \n") >> "essy.txt";

   printf("graph.addNode( \"" nodid "\", \"" noda "\", \"" nodsi "\", \"" linkcol[nodact] "\")\; \n") >> "essy.txt";
...
#  printf("graph.addLink( \"" linksou "\", \"" linktar "\",  \"" linkbond "\", \""  linkactt "\"); \n") >> "essy.txt";
...
#   printf("keepNodesOnTop()\; \n \n \}, nextval())\; \n \n") >> "essy.txt";
 ...
 for (nof in proposed_all_edge_source) { delete proposed_all_edge_source[nof];}
   ...
   for (nof in proposed_al_node_actor) {delete proposed_all_node_actor[nof];}
...
#  linkbo=all_edge_bond[link];
 ...
 for (nof in proposed_all_node_actor) { delete proposed_all_node_actor[nof];}
