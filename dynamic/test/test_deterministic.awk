...
# produce a mol file
 ...
 molname="tempo_" kicounter ".mol";
 
 printf("\n \n") > molname;
 
 for (fg in all_node_atom) {
 
 molnode=all_node_atom[fg];
 
 molid=all_node_id[fg];
 
 if (molnode=="A" || molnode=="L" || molnode=="FI" || molnode=="FO" || molnode=="FOE") {
 
 molj1=molid "_1";
 molj2=molid "_2";
 molj3=molid "_3";
 
 molport1=all_edge_out[molj1];
 molport2=all_edge_out[molj2];
 molport3=all_edge_out[molj3];
 
 printf(molnode " " molport1 " " molport2 " " molport3 "\n") >> molname;
 ...
 printf(molnode " " molport1 " " molport2 "\n") >> molname;
 
     }
     
  if (molnode=="FRIN" || molnode=="FROUT" || molnode=="T") {
...
# sum of weigths for deterministic vs random

 wei_wei=wei_L3T+wei_A3TFI3T+wei_FO3T+wei_FO2TFOET+wei_FOFOE+wei_LFOELFO+wei_AFOAFOE+wei_FIFO+wei_FIFOE+wei_AL;
...
} else {      if (wei_wei==0) { counter=cycounter; } else { counter++; }
