...
#
# this file forked from foe_bubbles_09_10.awk  owner: chorasimilarity (Marius Buliga, http://chorasimilarity.wordpress.com/ )
#
# 
#  the goal is to introduce some generic nodes: 
#  - NOP2 does nothing (in-out ports) (Joshua and Louis asked for it) [is needed a NOP3 with 3 ports? a NOPA, NOPL?]
#  - MULIN, has 2 ports, if the in port is free and the out port connects to FO or FOE then is a multiplicator
#  - MULOUT, has 2 ports, if the port out is free then it behaves like a TERM 
#  - PROP has two ports, if the out port connects to FO or FOE then propagates and the FO or FOE becomes FOE
#  - DISA  is a distributor like A  (distributes with FO or FOE  and leaves behind two FOE)
#  - DISFI is a distributor like FI (distributes with FO only and leaves behind two FO)
#  - DISL  is a distributor like L  (distributes with FO or FOE and leaves behind a FI and a FOE)
#  - DISFO is a distributor like FO (distributes with FOE only and leaves behind a FI and a FOE)
#
# the priority of the moves will be the same as the one for the original moves: MULOUT like LOC-PR, MULIN, PROP and DISFO like DIST-FOE (DIST-NEW), 
# DISA like DIST-A, DISFI like DIST-FI, DISL like DIST-L. 
#
...
# ignores the lines with less than 2 fields
...
#
# for NF=3 it can be Arrow, NOP2, MULIN, MULOUT, PROP
#
       ...
       if ( NF == 3 ) { 
                      ...
                      if ( ( e == "MULIN" ) || ( e == "PROP" )) {  active_edge[c]++;  }

                      if (  e == "MULOUT" ) {  active_edge[b]++;  
...
#  
#  the active edge for MULIN is 2-1
#  the active edge for PROP is 2-1
#  the active edge for MULOUT is 1 is like for LOC-PR
#
#
#
...
# for DIST-L the active edge is the 3-1 edge [DISL move added]
...
#
                                                            ...
                                                            if (( n_out == "L" || n_out == "DISL" ) && ( n_in == "FO" || n_in == "FOE" ) ) {
...
#
                                                           ...
                                                           counter_new_nodes++;
                                                            ...
                                                            t_4="L" " " cdd " " cbb " "  node_port_3[u]; } else { 

                                                            t_3="DISL" " " ccc " " caa " "  node_port_2[u]; 

                                                            t_4="DISL" " " cdd " " cbb " "  node_port_3[u]; }
...
#
                                                            if (( n_out == "A" || n_out == "DISA" ) && ( n_in == "FO" || n_in == "FOE" ) ) {
                                                           ...
                                                           counter_new_nodes++;
                                                            ...
                                                            t_4="A" " " cbb " " cdd " "  node_port_3[u]; } else { 

                                                            t_3="DISA" " " caa " " ccc " "  node_port_2[u]; 

                                                            t_4="DISA" " " cbb " " cdd " "  node_port_3[u]; }
...
#
                                                            if (( n_out == "FI" || n_out == "DISFI" ) &&  n_in == "FO" ) {
                                                           ...
                                                           counter_new_nodes++;
                                                            ...
                                                            t_4="FI" " " cbb " " cdd " "  node_port_3[u]; } else { 

                                                            t_3="DISFI" " " caa " " ccc " "  node_port_2[u]; 

                                                            t_4="DISFI" " " cbb " " cdd " "  node_port_3[u]; }
...
#
                                                            ...
                                                            if (( n_out == "FO" || n_out == "DISFO" ) &&  n_in == "FOE"  ) {
...
# modified here FO by FOE
                                                            ...
                                                            t_4="FO" " " cdd " " cbb " "  node_port_3[u]; } else {


                                                            t_3="DISFO" " " ccc " " caa " "  node_port_2[u]; 

                                                            t_4="DISFO" " " cdd " " cbb " "  node_port_3[u]; }
...
# the moves PROP and MULIN


                                                            if (( n_out == "PROP" || n_out == "MULIN" ) && ( n_in == "FOE" || n_in == "FO")  ) {
...
# 
                                                            ...
                                                            t_2= n_out " " caa " "   node_port_2[u]; 

                                                            t_3= n_out " " cbb " "  node_port_3[u]; 
...
# the move MULIN-MULOUT

                                                            if ( n_out == "MULIN" &&  n_in == "MULOUT"  ) {
                                                            ...
                                                            type_move[i]="MULINMULOUT"; 
                                                            
                                                             t_1="Arrow" " " node_port_1[v] " " node_port_2[u];

                                                            printf("FRIN" " " node[v] " " node[u]  " " "REPLACED BY" " " t_1   "\n") > "temp_proposed_moves";
...
# the move FRIN  [COMMENTED]



#                                                            if ( n_out == "FRIN" && ( n_in == "FOE" || n_in == "FO")  ) {
...
#                                                            t_2= "MULOUT" " " caa " "   node_port_2[u]; 

#                                                            t_3= "MULOUT" " " cbb " "  node_port_3[u]; 


#                                                            printf("FRIN" " " node[v] " " node[u]  " " "REPLACED BY" " " t_1 " " t_2 " " t_3  "\n") > "temp_proposed_moves";
...
## the MULOUT FOR A AND FI


                                                            if (( n_out == "A" || n_out == "FI" ) && n_in == "MULOUT") {   
...
# 
                                                            t_1= n_out  " " caa " " cbb  " " node_port_2[u];

                                                            t_2= "MULOUT" " " node_port_1[v] " " caa;  

                                                            t_3= "MULOUT" " "   node_port_2[v] " " cbb ; 


                                                            printf("MULOUT" " " node[v] " " node[u]  " " "REPLACED BY" " " t_1 " " t_2 " " t_3  "\n") > "temp_proposed_moves";
...
#
# the priority choice works by first removing anything which competes with DIST-FOE (i.e. "DIST-NEW"), then apply the viral priority choice on the remaining moves. That's why the move_left is traversed twice
#
...
# first traversal of move_left, exclusively for detecting DIST-NEW
      ...
      for ( k in move_left) { 
                             ...
                             printf("DIST-NEW deleted 1st traversal " move_right[dudu_left_1] "\n") > "temp_del_moves";
...
# second traversal, as usual for viral choice
      ...
      for ( k in move_left) { 
                             ...
                             if (tu == "LOC-PR" && cucu > 1) { 
                              printf("LOC-PR deleted 1st traversal " move_right[k] "\n") > "temp_del_moves";                            
                              delete move_left[k]; delete move_right[k]; }

#                             if (tu == "DIST-NEW" && cucu == 2 ) { 

#                               printf("DIST-NEW deleted 2nd traversal " move_right[k] "\n") > "temp_del_moves";
#  delete move_left[k]; delete move_right[k];}

                             if (tu == "DIST" && cucu == 2 && coocoo == "A") { 
                             
                             printf("DIST-NEW deleted 2nd traversal " move_right[dudu] "\n") > "temp_del_moves";                             
                             dudu=node_port_1[coco] ; delete move_left[dudu]; delete move_right[dudu]; }
 
                                                             

                            } 

     for ( ik in move_left ) {                    printf(move_left[ik]) > "temp_trashed_nodes"; printf(move_right[ik]) > "temp_added_nodes"; 
    ...
    for (i in inter_node ) {
                          ...
                          if (nana == 2 ) { u=tem[1]; v=tem[2];
                           ...
                           if (nana == 3 ) { u=tem[1]; v=tem[2]; w=tem[3];
                                          ...
                                          if ( u == "Arrow" ) { is_arrow[v]++; } else {is_not_arrow[i]++;}
                           ...
                           if (nana == 4 ) { u=tem[1]; v=tem[2]; w=tem[3]; z=tem[4];
                                          ...
                                          if ( ( u == "A" )  || ( u == "FI" ) || ( u == "DISA" ) || ( u == "DISFI") ) { inter_in_port[w]=i; } else { inter_out_port[w]=i; }             
...
##########################################################################################################################################
                                                                  ...
                                                                  if (arroin_type == "A" || arroin_type == "FI" || arroin_type == "DISA" || arroin_type == "DISFI" )  { 
                                                                  ...
                                                                  if (arroin_type == "L" || arroin_type == "FO" || arroin_type == "FOE" || arroin_type == "DISL" )  { 
...
#                        if ( zuzu == "Arrow" ) { delete inter_node[i]; } 
                        ...
                        if (zuzu == "PROP" || zuzu == "MULOUT" || zuzu == "MULIN" || zuzu == "NOP2"  ) { inter_node[i]=zuzu " " inter_node_port_1[i] " " inter_node_port_2[i]; }



                        if (zuzu == "A" || zuzu == "L" || zuzu == "FI" || zuzu == "FO" || zuzu == "FOE" || zuzu == "DISA" || zuzu == "DISL" || zuzu == "DISFO" || zuzu == "DISFI" ) { inter_node[i]=zuzu " " inter_node_port_1[i] " " inter_node_port_2[i] " " inter_node_port_3[i]; }
...
#
    ...
    zeze=inter_node_type[i]; if (zeze != "Arrow" ) {conode++;}

}} 

   printf(conode) > "temp_for_count";
