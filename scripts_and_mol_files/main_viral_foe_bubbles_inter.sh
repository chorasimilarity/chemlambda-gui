...
awk -f check_1_foe.awk temp_before_comb
...
printf "5 reduction steps available, along with the pre- and post application of COMB moves. Look at them with look.html in your browser" 
