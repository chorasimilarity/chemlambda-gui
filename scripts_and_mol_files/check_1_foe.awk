...
# forked from check_1.awk version 22.09.2014
#
...
#                                  all_node_text[j]="port_3" zu;
                    ...
                    if (s == "FI") { zu=s node_port_1[i] node_port_2[i] node_port_3[i]; a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i];
                                  used_port_i[a]++;
                                  used_port_i[b]++;
                                  used_port_i[c]++;
                                  used_port[a]++;
...
#                                  all_node_text[j]="port_3" zu;
                    ...
                    if (s == "L") { zu=s node_port_1[i] node_port_2[i] node_port_3[i]; a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i];
                                  used_port_i[a]++;
                                  used_port_i[b]++;
                                  used_port_i[c]++;
                                  used_port[a]++;
...
#                                  all_node_text[j]="port_3" zu;
                    ...
                    if (s == "FO" ) { zu=s node_port_1[i] node_port_2[i] node_port_3[i]; a=node_port_1[i]; b=node_port_2[i]; c=node_port_3[i];
                                  used_port_i[a]++;
                                  used_port_i[b]++;
                                  used_port_i[c]++;
                                  used_port[a]++;
...
#                                  all_node_text[j]="port_3" zu;
                    ...
                    if (s == "Arrow") { zu=s node_port_1[i] node_port_2[i]; a=node_port_1[i]; b=node_port_2[i];
                                  used_port_i[a]++;
                                  used_port_i[b]++;
                                  used_port[a]++;
                                  used_port[b]++;
...
#                                  all_node_text[j]="port_1" zu;
    ...
    for (i in used_port) { a=used_port[i]; if (a == 2) { if (cucu == 0 ){ 
